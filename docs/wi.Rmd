...
Polling locations are not supposed to change in the month before an election but `¯\_(ツ)_/¯`

```{r}
old_locations <- readxl::read_xlsx(here::here("data", "2020 General Election PPL RU List.xlsx")) %>% 
  select(County, Muni, ReportingUnit, PollingPlaceName, PollingPlaceAddress, Longitude, Latitude)
